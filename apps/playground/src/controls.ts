...
export const colorControls: Record<PlaygroundEffectId, readonly ColorControl[]> = {
  ...
  mosaic: [{ key: "tint", label: "Tile color" }],
  rings: [{ key: "tint", label: "Ring color" }],
  contour: [{ key: "tint", label: "Stroke color" }],
...
export const effectControls: Record<PlaygroundEffectId, readonly EffectControl[]> = {
  ...
  mosaic: [
    ...pushControls,
    { key: "spacing", label: "Tile size", min: 6, max: 32, step: 1 },
  ],
  rings: [
    ...pushControls,
    { key: "spacing", label: "Cell size", min: 8, max: 36, step: 1 },
  ],
  contour: [
    ...pushControls,
    { key: "spacing", label: "Stroke pitch", min: 5, max: 24, step: 1 },
    { key: "angleRange", label: "Angle range", min: 15, max: 180, step: 1, unit: "°" },
  ],
}
